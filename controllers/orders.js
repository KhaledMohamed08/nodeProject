...
function createorder(order,req,res){
 ...
 return db.execute(" insert into orders (name,user_id) values(?,?) ",[order.name,order.user_id] );
...
module.exports={updateorderById,createorder,getorderById,getAllorders,deleteorderbyid}